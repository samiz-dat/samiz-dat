...
var bluebird = __webpack_require__(29)();
...
var escapeStringRegexp = __webpack_require__(43);
...
var APPLY = {};
var NEXT_FILTER = {};
var tryConvertToPromise = __webpack_require__(40)(Promise, INTERNAL);
var PromiseArray =
...
var PassThroughHandlerContext =
    __webpack_require__(23)(Promise, tryConvertToPromise);
...
__webpack_require__(27)(Promise, INTERNAL, tryConvertToPromise, apiRejection,
    debug);
__webpack_require__(14)(Promise, INTERNAL, tryConvertToPromise, debug);
__webpack_require__(16)(Promise, PromiseArray, apiRejection, debug);
...
__webpack_require__(12)(Promise);
...
"use strict";
let start = (() => {var _ref = _asyncToGenerator(
  ...
  function* (dat) {
    ...
    archive.on('download', function (data) {
      console.log(_chalk2.default.gray(_chalk2.default.bold('downloading:'), data));
    });
    ...
    list.forEach(function ({ type, name }) {
      console.log(type === 'file' ? _chalk2.default.bold(name) : name);
    });
  });return function start(_x) {return _ref.apply(this, arguments);};})();var _path = __webpack_require__(10);var _path2 = _interopRequireDefault(_path);var _datNode = __webpack_require__(9);var _datNode2 = _interopRequireDefault(_datNode);var _lodash = __webpack_require__(8);var _lodash2 = _interopRequireDefault(_lodash);var _bluebird = __webpack_require__(6);var _bluebird2 = _interopRequireDefault(_bluebird);var _chalk = __webpack_require__(7);var _chalk2 = _interopRequireDefault(_chalk);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _asyncToGenerator(fn) {return function () {var gen = fn.apply(this, arguments);return new _bluebird2.default(function (resolve, reject) {function step(key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {return _bluebird2.default.resolve(value).then(function (value) {step("next", value);}, function (err) {step("throw", err);});}}return step("next");});};}const testDir = _path2.default.join(process.cwd(), 'test-dir');const opts = { key: 'fbdf68b3d65bd1cb46057d9b014a8db269a969185e435f683222d05f0809570e', sparse: true };

(0, _datNode2.default)(testDir, opts, (err, dat) => {
  if (err) {
    console.error(err);
    return;
  }
